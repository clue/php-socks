...
class Socks4
{
     ...
     *
     * @param string|int|NULL|resource $socksServer
     *            hostname / port or (not recommended:) established connection stream
     * @param int|NULL $port
     *            port
     */
     ...
     *            to operate on
     * @param int $len
     *            ensure full length will be read
     ...
     *            to operate on
     * @param string $string
     *            ensure full string will be written
